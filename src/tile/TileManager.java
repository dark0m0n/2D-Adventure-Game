...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        setup(6, "sand_4", false);
        setup(7, "sand_5", false);
        setup(8, "sand_6", false);
        setup(9, "sand_7", false);
        setup(10, "sand_8", false);
        setup(11, "sand_9", false);
        setup(12, "sand_10", false);
        setup(13, "sand_11", false);
        setup(14, "sand_12", false);
        setup(15, "sand_13", false);
        ...
        // water
        setup(18, "water_1", true);
        setup(19, "water_2", true);
        setup(20, "water_3", true);
        setup(21, "water_4", true);
        setup(22, "water_5", true);
        setup(23, "water_6", true);
        setup(24, "water_7", true);
        setup(25, "water_8", true);
        setup(26, "water_9", true);
        setup(27, "water_10", true);
        setup(28, "water_11", true);
        setup(29, "water_12", true);
        setup(30, "water_13", true);
        setup(31, "water_14", true);
    }
